const logotext = " ابـــو صــــدام لــــشراء الاثــــاث ";
const meta = {
    title: "{Your name}",
...
const introdata = {
    ...
    animated: {
        first: " مـــرحبـــا بــكم فـــي مــــوقعـــنا ",
        second: " افضـــل شركـــة لنقــل العفــش ",
...
const worktimeline = [{
        jobtitle: "ترحــــال اثـــاثــات",
        where: "الممـــلكه العـــربــيه الســـعوديه",
        date: "2023-2024",
    },
    {
        jobtitle: "ترحـــال عفـــــــش ",
        where: "الممـــلكه العـــربــيه الســـعوديه",
        date: "2023-2024",
    },
    {
        jobtitle: "ترحــــال منــــازل ",
        where: "الممـــلكه العـــربــيه الســـعوديه",
        date: "2023-2024",
    },
];
